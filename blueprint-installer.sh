...
echo -e "${CYAN}"
cat << "EOF"
  ____  _       _____  _____   ___   ____  ____   ____  
 | __ )| |     | ____|| ____| |_ _| |  _ \|  _ \ / ___| 
 |  _ \| |     |  _|  |  _|   | |  | |_) | |_) | |  _|  
 | |_) | |___  | |___ | |___  | |  |  __/|  _ <| |_| | 
 |____/|_____||_____||_____||___| |_|   |_| \_\\____| 
                    _   _       _                       
      __| | __ _| |_| |_ ___| |__   __ _ ___ _ __ ___  
     / _` |/ _` | __| __/ _ \ '_ \ / _` / __| '_ ` _ \ 
    | (_| | (_| | |_| ||  __/ | | | (_| \__ \ | | | | |
     \__,_|\__,_|\__|\__\___|_| |_|\__,_|___/_| |_| |_|
EOF
echo -e "${RESET}"

echo -e "${GREEN} BLIZZARD INSTALLER — BY TUSHAR ${RESET}"
echo
